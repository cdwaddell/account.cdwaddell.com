...
using Account.CdWaddell.Identity;
using Account.CdWaddell.Services;
using Microsoft.AspNetCore.Authorization.Infrastructure;
using SendGrid;

namespace Account.CdWaddell
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connectionString = Configuration.GetConnectionString("CdWaddellContext");
            
            services.AddDbContext<CdWaddellContext>(builder =>
            ...
            services.AddIdentity<CustomUser, CustomRole>(options =>
                ...
                .AddEntityFrameworkStores<CdWaddellContext>()
            ...
            services.AddScoped<DbValidationKeyStore>();
            services.AddTransient<IValidationKeysStore>(c => c.GetService<DbValidationKeyStore>());
            services.AddTransient<ISigningCredentialStore>(c => c.GetService<DbValidationKeyStore>());

            idServerBuilder.Services.AddSingleton(new ConfigurationStoreOptions());
            idServerBuilder.Services.AddScoped<IConfigurationDbContext, CdWaddellContext>();
            ...
            idServerBuilder.Services.AddScoped<IPersistedGrantDbContext, CdWaddellContext>();
